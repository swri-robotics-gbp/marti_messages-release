## marti_messages (noetic) - 0.12.2-1

The packages in the `marti_messages` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --edit --rosdistro noetic marti_messages` on `Fri, 03 Nov 2023 18:42:35 -0000`
...
## marti_messages (noetic) - 0.12.1-1

The packages in the `marti_messages` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --edit --rosdistro noetic marti_messages` on `Fri, 18 Aug 2023 20:12:58 -0000`
...
## marti_messages (noetic) - 0.12.0-1

The packages in the `marti_messages` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --edit --rosdistro noetic marti_messages` on `Tue, 15 Aug 2023 18:49:56 -0000`
...
## marti_messages (noetic) - 0.11.0-3

The packages in the `marti_messages` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --rosdistro noetic --track noetic marti_messages` on `Fri, 26 Aug 2022 20:30:15 -0000`
...
## marti_messages (noetic) - 0.11.0-2

The packages in the `marti_messages` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --rosdistro noetic --track noetic marti_messages` on `Fri, 26 Aug 2022 19:34:32 -0000`
...
## marti_messages (noetic) - 0.11.0-1

The packages in the `marti_messages` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --rosdistro noetic --track noetic marti_messages` on `Thu, 04 Aug 2022 17:34:00 -0000`
...
## marti_messages (melodic) - 0.11.0-3

The packages in the `marti_messages` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --rosdistro melodic --track melodic marti_messages` on `Thu, 04 Aug 2022 17:24:01 -0000`
...
## marti_messages (melodic) - 0.11.0-2

The packages in the `marti_messages` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --rosdistro melodic --track melodic marti_messages` on `Thu, 04 Aug 2022 17:18:33 -0000`
...
## marti_messages (melodic) - 0.11.0-1

The packages in the `marti_messages` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --rosdistro melodic --track melodic marti_messages` on `Thu, 04 Aug 2022 17:08:39 -0000`
...
## marti_messages (rolling) - 1.2.0-1

The packages in the `marti_messages` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling marti_messages` on `Thu, 02 Sep 2021 17:52:33 -0000`
